...
CREATE TABLE "posta_receipt_item" (
    "id" UUID NOT NULL,
    ...
    CONSTRAINT "posta_receipt_item_pkey" PRIMARY KEY ("id")
);

CREATE INDEX "posta_receipt_item_receipt_order_id_idx" ON "posta_receipt_item"("receipt_order_id");
